...
- 청소년 기준 일일 목표와 비교해 과도한 영양소와 부족한 영양소를 푸드 캘린더에서 표시합니다.
...
- `/meal`: NEIS 급식표, 점심 영양 비교, 숟가락·국물 섭취 조절, 급식 기록
- `/scan`: 카메라 바코드 조회, 제품 영양, 섭취량 기록, 포장재 분리배출
- `/calendar`: 월간 기록, 날짜별 식단 노트, 일일 목표 대비 과다·부족 판정
